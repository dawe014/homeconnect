...
// Register all necessary Chart.js components, including Filler
ChartJS.register(
  CategoryScale,
  LinearScale,
  BarElement,
...
// API function to fetch all dashboard statistics
...
export default function AdminOverview() {
  ...
  // --- Data for the Pie Chart (Properties by Type) ---
  ...
  const listingsLast7DaysData = () => {
    // 1. Create labels for the last 7 days in chronological order
    const labels = Array.from({ length: 7 }, (_, i) => {
      const d = new Date();
      d.setDate(d.getDate() - (6 - i)); // Start from 6 days ago up to today
    ...
    // 2. Efficiently group property counts by date using a Map
    ...
    // 3. Map the labels to their corresponding counts, defaulting to 0
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="h-[300px]">
            <Line
              data={listingsLast7DaysData()} // Call the function to get calculated data
